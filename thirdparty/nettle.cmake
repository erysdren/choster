...
set(NETTLE_SRC
	...
	${NETTLE_DIR}/balloon.c
	${NETTLE_DIR}/balloon-sha1.c
	${NETTLE_DIR}/balloon-sha256.c
	${NETTLE_DIR}/balloon-sha384.c
	${NETTLE_DIR}/balloon-sha512.c
	...
	${NETTLE_DIR}/siv-gcm.c
	${NETTLE_DIR}/siv-gcm-aes128.c
	${NETTLE_DIR}/siv-gcm-aes256.c
	...
	${NETTLE_DIR}/siv-ghash-set-key.c
	${NETTLE_DIR}/siv-ghash-update.c
	${NETTLE_DIR}/gcm.c
	...
	${NETTLE_DIR}/gcm-sm4.c
	${NETTLE_DIR}/gcm-sm4-meta.c
	${NETTLE_DIR}/cmac.c
	${NETTLE_DIR}/cmac64.c
...
add_library(nettle STATIC ${NETTLE_SRC})
target_include_directories(nettle PUBLIC ${NETTLE_DIR})
target_compile_definitions(nettle PUBLIC "NORETURN=__attribute__ ((__noreturn__))")
target_compile_definitions(nettle PUBLIC "UNUSED=__attribute__ ((__unused__))")
target_compile_definitions(nettle PUBLIC "__GNU_LIBRARY__")
